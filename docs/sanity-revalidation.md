...
This site uses `next-sanity/live` for normal content freshness and visual editing. A signed Sanity webhook provides an additional production revalidation path for statically generated routes and `sitemap.xml`.
...
- Name: `Chloe Patterson PM route revalidation`
